...
import (
	...
	"github.com/TheManticoreProject/ShadowCredentials/modes/mode_attach"
	"github.com/TheManticoreProject/ShadowCredentials/modes/mode_create"
	"github.com/TheManticoreProject/ShadowCredentials/modes/mode_extract"
	"github.com/TheManticoreProject/ShadowCredentials/modes/mode_flush"
	"github.com/TheManticoreProject/ShadowCredentials/modes/mode_info"
	"github.com/TheManticoreProject/ShadowCredentials/modes/mode_list"
	"github.com/TheManticoreProject/ShadowCredentials/modes/mode_remove"
	"github.com/TheManticoreProject/ShadowCredentials/modes/mode_spray"
...
func parseArgs() {
	ap := parser.ArgumentsParser{Banner: "shadowcredentials - by Remi GASCOU (Podalirius) @ TheManticoreProject - v1.0.0"}
	...
	// remove ==================================================================================================================
	subparser_remove := ap.AddSubParser("remove", "Remove a KeyCredentialLink from one or more objects.")
	subparser_remove.NewBoolArgument(&debug, "", "--debug", false, "Enable debug mode.")

	// spray ==================================================================================================================
	subparser_spray := ap.AddSubParser("spray", "Add a new or existing KeyCredentialLink to one or more objects.")
